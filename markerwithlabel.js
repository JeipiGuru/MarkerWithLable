...
function MarkerLabel_(marker, crossURL) {
  ...
  //For Area
  this.areaDiv_ = document.createElement("div");
  this.areaDiv_.style.cssText = "position: absolute; overflow: hidden;";
...
MarkerLabel_.prototype.onAdd = function () {
  ...
  // For Area
  this.getPanes().markerLayer.appendChild(this.areaDiv_);
...
MarkerLabel_.prototype.addMouseListeners = function () {
  ...
  this.listeners1_ = [
    ...
    google.maps.event.addListener(this.marker_, "dragstart", function (mEvent) {
      ...
      // For Area
      me.areaDiv_.style.zIndex = me.labelDiv_.style.zIndex + 1000000;
...
MarkerLabel_.prototype.onRemove = function () {
  ...
  //For Area
  if (this.areaDiv_.parentNode) {
    this.areaDiv_.parentNode.removeChild(this.areaDiv_);
  }
 ...
 */
// For Area
MarkerLabel_.prototype.setArea = function () {
  if (this.marker_.save == false) {
    var width, height;
    if (this.marker_.get("areaSize") === "undefined") {
      width = 50; height=50;
    } else {
      width = this.marker_.get("areaSize").width; height = this.marker_.get("areaSize").height;
    }
    var color;
    if (this.marker_.get("areaColor") === "undefined") {
      color='red';
    } else {
      color = this.marker_.get("areaColor");
    }
    var opacity;
    if (this.marker_.get("areaSize") === "undefined") {
      opacity = 0.5;
    } else {
      opacity = this.marker_.get("areaOpacity");
      opacity = (opacity > 1.0) ? 1.0 : opacity;
      opacity = (opacity < 0.0) ? 0.0 : opacity;
    }
    var radius;
    if (this.marker_.get("areaRadius") === "undefined") {
      radius = 50;
    } else {
      radius = this.marker_.get("areaRadius");
      radius = (radius > 100) ? 100 : radius;
      radius = (radius < 0) ? 0 : radius;
    }
    this.areaDiv_.style.cssText += "width: " + width + "px;" +
                                   "height: " + height + "px;" +
...
MarkerLabel_.prototype.setMandatoryStyles = function () {
  ...
  // For Area 
  this.areaDiv_.style.position = this.labelDiv_.style.position;
  this.areaDiv_.style.overflow = this.labelDiv_.style.overflow;
...
MarkerLabel_.prototype.setAnchor = function () {
  ...
  //For Area
  var x, y;
  if (this.marker_.get("areaAnchor") === "undefined") {
    x = -5; y = -45;
  } else {
    x = this.marker_.get("areaAnchor").x; y = this.marker_.get("areaAnchor").y;
  }
  this.areaDiv_.style.marginLeft = -anchor.x + x + "px";
  this.areaDiv_.style.marginTop = -anchor.y + y + "px";
...
MarkerLabel_.prototype.setPosition = function () {
  ...
  // For Area
  this.areaDiv_.style.left = this.labelDiv_.style.left;
  this.areaDiv_.style.top = this.labelDiv_.style.top;
...
MarkerLabel_.prototype.setZIndex = function () {
  ...
  if (typeof this.marker_.getZIndex() === "undefined") {
    ...
    // For Area
    this.areaDiv_.style.zIndex = this.labelDiv_.style.zIndex + 1000000;
    this.eventDiv_.style.zIndex = this.labelDiv_.style.zIndex;
  } else {
    this.labelDiv_.style.zIndex = this.marker_.getZIndex() + zAdjust;
    // For Area
    this.labelDiv_.style.zIndex = this.labelDiv_.style.zIndex + 1000000;
    this.eventDiv_.style.zIndex = this.labelDiv_.style.zIndex;
  }
};
